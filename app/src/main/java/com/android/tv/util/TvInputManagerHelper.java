...
public class TvInputManagerHelper {
    ...
    private static final List<Integer> DEFAULT_TV_INPUT_PRIORITY = new ArrayList<>();
...
//    };
    ...
    private final Set<TvInputCallback> mCallbacks = new HashSet<>();
    ...
    public void start() {
        ...
        com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG, "start");
        mStarted = true;
        ...
        for (TvInputInfo input : mTvInputManager.getTvInputList()) {
            com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG, "Input detected " + input);
    ...
    public void updateParserRating(){
    	mContentRatingsManager.update();
    }

    public void updateParserRatingForChangeLanguage(){
        mContentRatingsManager.updateForChangeLanguage();
    }
    ...
    public boolean isBundledInput(TvInputInfo inputInfo) {
        return inputInfo != null
                && inputInfo.getServiceInfo().applicationInfo.packageName.equalsIgnoreCase("com.android.tv");
    }
...
//                mStarted, TAG, "hasTvInputInfo() called before TvInputManagerHelper was started.");
        com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG,"mStarted is "+mStarted+" inputId "+inputId);
        /*for (TvInputInfo tvInputInfo : mInputMap.values()) {
          com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG, "hasTvInputInfo tvInputInfo "+tvInputInfo);
        } */
...
//        SoftPreconditions.checkState(mStarted, TAG, "AvailabilityManager not started");
    ...
    public static String loadLabel(Context context, TvInputInfo input) {
        ...
        TvInputManagerHelper inputManager =
                com.mediatek.wwtv.tvcenter.TvSingletons
                .getSingletons().getTvInputManagerHelper();
