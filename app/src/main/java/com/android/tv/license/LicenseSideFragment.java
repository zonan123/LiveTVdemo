...
public final class LicenseSideFragment extends SideFragment {
    public static final String TAG = "LicenseSideFragment";
    ...
    public class LicenseActionItem extends ActionItem {
        ...
        protected void onSelected() {
            ...
            LicenseDialogFragment.newInstance(license);
            /*
            getMainActivity()
                    .getOverlayManager()
    ...
    private List<LicenseActionItem> toActionItems(List<License> licenses) {
        List<LicenseActionItem> items = new ArrayList<LicenseActionItem>(licenses.size());
