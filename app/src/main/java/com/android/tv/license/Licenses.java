...
public final class Licenses {
    ...
    private Licenses() {
    	Log.d(TAG, "Licenses Constructor");
    };
    ...
    public static List<License> getLicenses(Context context) {
     ...
     */
    private static List<License> getLicenseListFromMetadata(String metadata, String filePath) {
    ...
    private static String getTextFromResource(
		...
		try {
			stream = context.getApplicationContext().getResources()
					.openRawResource(resourcesIdentifier);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			if (stream != null) {
