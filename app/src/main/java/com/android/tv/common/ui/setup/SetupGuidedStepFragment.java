...
public abstract class SetupGuidedStepFragment extends GuidedStepFragment {
    ...
    public View onCreateView(
        ...
        view.findViewById(R.id.action_fragment_root)
                .setPadding(0, 0, 0, 0);
        mContentFragment = view.findViewById(R.id.content_fragment);
