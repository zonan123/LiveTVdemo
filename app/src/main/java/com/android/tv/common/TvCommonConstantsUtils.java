 ...
 */
public final class TvCommonConstantsUtils {
    public String toString() {
        return "TvCommonConstantsUtils";
    }

    private TvCommonConstantsUtils() {
    }
    /**
     * A constant for the key of the extra data for the app linking intent.
     */
    public final static String EXTRA_APP_LINK_CHANNEL_URI = "app_link_channel_uri";
     ...
     */
    public final static String EXTRA_SETUP_INTENT =
