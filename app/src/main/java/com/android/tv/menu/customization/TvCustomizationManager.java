...
public class TvCustomizationManager {
    ...
    private static final Map<String, String> INTENT_CATEGORY_TO_ROW_ID;
    static {
        INTENT_CATEGORY_TO_ROW_ID = new HashMap<String, String>();
    ...
    private final Map<String, List<CustomAction>> mRowIdToCustomActionsMap = new HashMap<String, List<CustomAction>>();
    ...
    private void buildCustomActions() {
        ...
        for (String intentCategory : INTENT_CATEGORY_TO_ROW_ID.keySet()) {
            ...
            for (ResolveInfo info : activities) {
                ...
                if (TextUtils.isEmpty(mCustomizationPackage)) {
                    if (DEBUG) {
                    	Log.d(TAG, "Found TV customization package " + packageName);
                    }
    ...
    private void buildPartnerRow() {
        ...
        if (DEBUG) {
        	Log.d(TAG, "Partner row title [" + mPartnerRowTitle + "]");
        }
    }
