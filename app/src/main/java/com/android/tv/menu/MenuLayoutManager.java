...
public class MenuLayoutManager {
    ...
    private boolean isVisibleInLayout(
        ...
        return 	view.getVisibility() != View.GONE 
        		&& !rowsToRemove.contains(position)
        ...
        mAnimatorSet.addListener(
                new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        oldView.setImportantForAccessibility(View.IMPORTANT_FOR_ACCESSIBILITY_YES);
    ...
    public void onMenuRowUpdated() {
        ...
        if (addedRowViews.isEmpty() && removedRowViews.isEmpty()) {
            return;
        }
