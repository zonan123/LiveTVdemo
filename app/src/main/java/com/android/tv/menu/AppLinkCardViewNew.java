...
public class AppLinkCardViewNew extends BaseCardView<MenuAction> {
	private static final String TAG = "AppLinkCardViewNew";
	...
	public AppLinkCardViewNew(Context context) {
		this(context, null);
	}

	public AppLinkCardViewNew(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public AppLinkCardViewNew(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);

		mCardImageWidth = getResources().getDimensionPixelSize(
				R.dimen.action_card_width);
	...
	@Override
	public void onBind(MenuAction item, boolean selected) {
		TIFChannelInfo newChannel = item.getChannelInfo();
	...
	private static ImageLoader.ImageLoaderCallback<AppLinkCardViewNew> createChannelLogoCallback(
            AppLinkCardViewNew cardView, final TIFChannelInfo channel,
            final int type) {
		return new ImageLoader.ImageLoaderCallback<AppLinkCardViewNew>(cardView) {
			@Override
			public void onBitmapLoaded(AppLinkCardViewNew cardView,
