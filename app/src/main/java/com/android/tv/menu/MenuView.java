...
public class MenuView extends FrameLayout implements IMenuView {
                ...
                .addOnGlobalFocusChangeListener(
                        new OnGlobalFocusChangeListener() {
                            ...
                            public void onGlobalFocusChanged(View oldFocus, View newFocus) {
                          		Log.d(TAG, "Focus changed to " + oldFocus + newFocus);
                                MenuRowView newParent = getParentMenuRowView(newFocus);
                                if (newParent != null) {
                                    Log.d(TAG, "Focus changed to " + newParent);
                                    ...
                                    // in
                                    // setSelectedPosition().
                                    newParent.setImportantForAccessibility(View.IMPORTANT_FOR_ACCESSIBILITY_NO);
    ...
    public void onShow(
        ...
        if (position == -1 || !mMenuRows.get(position).isVisible()) {
            Log.d(TAG, "position == -1 || !mMenuRows.get(position).isVisible()");
            // Channels row is always visible.
            //WEI position = getItemPosition(ChannelsRow.ID);
        }
        setSelectedPosition(position);
    ...
    public void onHide() {
        ...
        MenuRowView menuRowView = getParentMenuRowView(getFocusedChild());
        if (menuRowView != null) {
        	menuRowView.setImportantForAccessibility(View.IMPORTANT_FOR_ACCESSIBILITY_YES);
		}
    ...
    public void updateLanguage(){
    	for (MenuRowView rowView : mMenuRowViews) {
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (direction == View.FOCUS_UP) {
            ...
            int selectedPosition = mLayoutManager.getSelectedPosition();
            if (oldfocusedParent != null && newFocusedParent != null && !newFocusedParent.equals(oldfocusedParent)) {
