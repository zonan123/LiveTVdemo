...
public class BaseActionFragment extends BaseScrollAdapterFragment
     ...
     */
    public static Bundle buildArgs(List<Action> actions, String name) {
     ...
     */
    public static Bundle buildArgs(List<Action> actions, int index) {
     ...
     */
    public static Bundle buildArgs(List<Action> actions, String name, int index) {
        Bundle args = new Bundle();
        args.putParcelableArrayList(EXTRA_ACTIONS, (ArrayList<Action>) actions);
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (hasCreatedView()) {
            ...
            outState.putParcelableArrayList(EXTRA_ACTIONS, (ArrayList<Action>)mAdapter.getActions());
