...
//    private static Object sInstLock = new Object();
    ...
    private PickerConstant(Resources resources) {
        ...
        hours12 = createStringIntArrays(11, true, 2);
        hours24 = createStringIntArrays(23, true, 2);
        minutes = createStringIntArrays(59, true, 2);
        seconds = createStringIntArrays(59, true, 2);
    ...
    static public synchronized PickerConstant getInstance(Resources resources) {
        if (sInst == null) {
