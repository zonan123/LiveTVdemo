...
public class ActionFragment extends ScrollAdapterFragment implements ActionAdapter.Listener,
    ...
    public static ActionFragment newInstance(List<Action> actions) {
        return newInstance(actions, null);
    }

    public static ActionFragment newInstance(List<Action> actions, String name) {
        ActionFragment fragment = new ActionFragment();
        fragment.setArguments(BaseActionFragment.buildArgs(actions, name));
        return fragment;
    }

    public static ActionFragment newInstance(List<Action> actions, int index) {
        ActionFragment fragment = new ActionFragment();
        fragment.setArguments(BaseActionFragment.buildArgs(actions, index));
        return fragment;
    }

    public static ActionFragment newInstance(List<Action> actions, String name, int index) {
        ActionFragment fragment = new ActionFragment();
