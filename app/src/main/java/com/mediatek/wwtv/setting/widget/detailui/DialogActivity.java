...
public abstract class DialogActivity extends Activity
    ...
    public static Intent createIntent(Context context, String title,
            String breadcrumb, String description, String imageUri,
            int imageBackground, List<Action> actions) {
        ...
        intent.putParcelableArrayListExtra(EXTRA_PARCELABLE_ACTIONS, (ArrayList<Action>)actions);
    ...
    public static Intent createIntent(Context context, String title,
            String breadcrumb, String description, String imageUri,
            List<Action> actions, Class<? extends DialogActivity> activityClass) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mLayoutResId == R.layout.two_pane_dialog_frame) {
            ...
            mWaiting = (ProgressBar)mContent.findViewById(R.id.waiting);
            mContentFragView = mContent.findViewById(R.id.content_fragment);
        }
...
//            finish();//not finish self add by bioaiqng
        }
    }
    ...
    protected void onPause() {
        ...
        super.onPause();
        if(mContentFragView != null){
        	mContentFragView.setVisibility(View.INVISIBLE);
        }
    ...
    protected void onResume() {
        ...
        super.onResume();
        if(mContentFragView != null){
        	mContentFragView.setVisibility(View.VISIBLE);
        }
