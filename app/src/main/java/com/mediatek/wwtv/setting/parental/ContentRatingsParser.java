...
import com.mediatek.wwtv.setting.parental.ContentRatingSystem.Order;
...
public class ContentRatingsParser {
    ...
    public static final String DOMAIN_SYSTEM_RATINGS = "com.mediatek.wwtv.setting";
    ...
    private List<ContentRatingSystem> parse(XmlResourceParser parser, String domain,
     ...
     //   while (parser.next() == XmlPullParser.START_DOCUMENT) {} fix PMD
