...
public class Picker extends Fragment {
    ...
    public interface ResultListener {
        void onCommitResult(String result);
    }
    ...
    private List<PickerColumn> mColumns = new ArrayList<PickerColumn>();
    ...
    private OnItemClickListener mOnClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            if (mKeyDown) {
                mKeyDown = false;
                mClicked = true;
                com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG, "onItemClick mClicked:"+mClicked);
...
//		}
     ...
     * the columns
     */
    protected List<PickerColumn> getColumns() {
        return null;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup mRootView = (ViewGroup) inflater.inflate(getRootLayoutId(), null);
        ViewGroup mPickerView = (ViewGroup) mRootView.findViewById(getPickerId());
        ...
        for (int i = 0; i < totalCol; i++) {
            ...
            columnView.setOnKeyListener(new View.OnKeyListener() {
                ...
                public boolean onKey(View v, int keyCode, KeyEvent event) {
                	com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG, "keyCode:"+keyCode + ", noKeyDown:" + mKeyDown);
                    switch (keyCode) {
                        ...
                        case KeyMap.KEYCODE_MTKIR_BLUE: 
                            mColumnViews.get(1).requestFocus();
                            break;
                        default:
                            	break;
                    }
    ...
    protected void updateAdapter(final int index, PickerColumn pickerColumn) {
        ...
        com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG, "selectedItemPosition:"+selectedItemPosition);
    ...
    private void updateAllColumnsForClick(boolean keyUp) {
        ...
        for (ScrollAdapterView mColumnView : mColumnViews) {
            ScrollAdapterView column = mColumnView;
        ...
        com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG, "animList.size():"+animList.size());
        if (animList != null && !animList.isEmpty()) {
            AnimatorSet animSet = new AnimatorSet();
            animSet.playTogether(animList);
            com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG, "mClicked="+mClicked+",keyUp="+keyUp);
            if (mClicked&&keyUp) {
                animSet.addListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                    	recordResult(mResult);
                    }
                });
            }
            animSet.start();
    ...
    protected void recordResult(List<String> mResult) {
    	 com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG,"recordResult");
    };
	...
	private void updateColumn(ScrollAdapterView column, boolean animateAlpha,
        ...
        List<Animator> localAnimList = animList;
        ...
        if (animateAlpha && animList == null && localAnimList != null && !localAnimList.isEmpty()) {
    ...
    private void setOrAnimateAlpha(View view, boolean animate, float destAlpha, float startAlpha,
            List<Animator> animList, Interpolator interpolator) {
    	com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG, "animate="+animate+",destAlpha="+destAlpha+",startAlpha="+startAlpha+",tag="+view.getTag());
        view.clearAnimation();
        if (!animate) {
    ...
    protected void onScroll(View v) {
    	 com.mediatek.wwtv.tvcenter.util.MtkLog.v(TAG, "onScroll");
    }
    ...
    private class PickerScrollArrayAdapter extends ScrollArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            com.mediatek.wwtv.tvcenter.util.MtkLog.v(TAG, "getView="+position);
    ...
    private class ChangeTextColorOnFocus implements View.OnFocusChangeListener,
        ...
        public void onFocusChange(View view, boolean hasFocus) {
            ...
            if (view instanceof ScrollAdapterView) {
                focusCount = mColumnViews.size();
                mColumnViews.stream().filter(columView->{
                    return mBackStack != null && !columView.hasFocus();
                }).forEach(columView ->{
                    focusCount --;
                    if(focusCount == 0){
                    	 mBackStack.accept(Picker.this);
                    }
