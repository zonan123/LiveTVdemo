...
public class DrawableDownloader {
    ...
    private static class BitmapItem {
        int mOriginalWidth;
        int mOriginalHeight;
       List<BitmapDrawable> mBitmaps = new ArrayList<BitmapDrawable>(3);
        int mByteCount;
        ...
        BitmapDrawable findLargestDrawable(BitmapWorkerOptions options) {
            return mBitmaps.isEmpty() ? null : mBitmaps.get(0);
        }
...
//    private static final Object sBitmapDownloaderLock = new Object();
     ...
     */
    public final static synchronized DrawableDownloader getInstance(Context context) {
