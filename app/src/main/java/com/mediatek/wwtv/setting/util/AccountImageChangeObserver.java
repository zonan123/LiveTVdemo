...
public class AccountImageChangeObserver {
    ...
    private Map<String, ContactChangeContentObserver> mObserverMap;

    /**
     * get the singleton AccountImageChangeObserver for the application
     */
    public final synchronized static AccountImageChangeObserver getInstance() {
        if (sObserver == null) {
