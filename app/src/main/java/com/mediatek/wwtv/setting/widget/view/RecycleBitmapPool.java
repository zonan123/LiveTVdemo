...
public class RecycleBitmapPool {
    ...
    private volatile static Method sGetAllocationByteCount;
   ...
   /* public RecycleBitmapPool() {
    ...
    public synchronized void addRecycledBitmap(Bitmap bitmap) {
    ...
    public synchronized Bitmap getRecycledBitmap(int width, int height) {
        ...
        synchronized(RecycleBitmapPool.class){
    ...
    private static Bitmap getRecycledBitmap(List<SoftReference<Bitmap>> list) {
