...
public class SetConfigListViewAdapter extends BaseAdapter{
    ...
    private SrctypeChangeListener srctypeChangelistener;
						...
						.setValueChangedListener(new OnValueChangedListener() {
							public void onValueChanged(View v, int value) {
								...
								String selId = v1.getmId();
								 if (selId.equals(DTV_TSHIFT_OPTION))
									{
								     com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG,"tshift_option");
										//TimeShiftManager.getInstance().setValueToPrefer(TimeShiftManager.DTV_TSHIFT_OPTION,value);
								} else if(selId.equals(SCHEDULE_PVR_SRCTYPE)) {
									srctypeChangelistener.srcTypeChange(value);
								}
							}
						});
	...
	public static class DataItem {
		...
		private DataType mDataType = DataType.OPTIONVIEW;
		...
		public enum DataType {
			OPTIONVIEW, POSITIONVIEW, PROGRESSBAR, HAVESUBCHILD, INPUTBOX, EFFECTOPTIONVIEW, SWICHOPTIONVIEW, CHANNELLISTVIEW, TEXTCOMMVIEW, SCANCHANNELSOPTIONVIEW, NUMVIEW, NUMADJUSTVIEW,  DATETIMEVIEW, CHANNELPOWERONVIEW, PASSWORDVIEW, FACTORYOPTIONVIEW, FACTORYPROGRESSVIEW, TVSOURCEVIEW, CHANNELPOWERNOCAHNNEL, CHANNELEUEDIT
		}
		...
		public Map<Integer, int[]> getmHashMap() {
			return mHashMap;
		}

		public void setmHashMap(Map<Integer, int[]> mHashMap) {
	...
	public SrctypeChangeListener getSrctypeChangelistener() {
		return srctypeChangelistener;
	}

	public void setSrctypeChangelistener(SrctypeChangeListener srctypeChangelistener) {
		this.srctypeChangelistener = srctypeChangelistener;
	}

	public interface SrctypeChangeListener{
		 void srcTypeChange(int value);
	}
}
