...
public class LocalSearchProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        List<SearchInterface> mSearch = new ArrayList<SearchInterface>();
        mSearch.add(new TvProviderSearch(getContext()));
        mSearch.add(new QuestionSearch(getContext()));
        ...
        if (!TextUtils.isEmpty(query)) {
			for(SearchInterface search : mSearch) {
    ...
    private Cursor createSuggestionsCursor(List<SearchResult> results) {
        ...
        for (SearchResult result : results) {
            Log.d(TAG, "title:" + result.title + ", " + result.description + ", " + result.imageUri + ", "
                    + result.intentAction + ", " + result.intentData);
            row.clear();
