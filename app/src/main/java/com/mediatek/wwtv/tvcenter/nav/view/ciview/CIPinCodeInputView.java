...
public class CIPinCodeInputView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		com.mediatek.wwtv.tvcenter.util.MtkLog.d("CIDIALOGEDIT", "onDraw===" + mCurrentSelectedPosition + ","
				+ textStr);
		if (!TextUtils.isEmpty(textStr)) {
			...
			if (mCurrentSelectedPosition != -1) {
				...
				if (mCurrentSelectedPosition == 0) {
					...
					com.mediatek.wwtv.tvcenter.util.MtkLog.d("CIDIALOGEDIT", "pos0--x===" + x + ",y==" + y);
					...
					com.mediatek.wwtv.tvcenter.util.MtkLog.d("CIDIALOGEDIT", "x===" + x + ",y==" + y);
					canvas.drawRect(x, fm.top + y - PADDING, x + offset,
							fm.bottom + y + PADDING, mPaint);
					mPaint.setColor(Color.GRAY);
	...
	public void setCursorPos(int keyCode) {
		...
		if (keyCode == KeyMap.KEYCODE_DPAD_LEFT) {
			com.mediatek.wwtv.tvcenter.util.MtkLog.d("CIDIALOGEDIT", "left cursor index:"
					+ mCurrentSelectedPosition);
			if (mCurrentSelectedPosition != 0) {
				--mCurrentSelectedPosition;
			}
			...
			com.mediatek.wwtv.tvcenter.util.MtkLog.d("CIDIALOGEDIT", "right cursor index:"
					+ mCurrentSelectedPosition);
