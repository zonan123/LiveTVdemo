...
public class CaptureSelectArea extends View implements View.OnKeyListener {
	...
	public CaptureSelectArea(Context context, AttributeSet attrs, int defStyle) {
		...
		com.mediatek.wwtv.tvcenter.util.MtkLog.e("tag", "rWidth:    "+rWidth+"  rHeight:"+rHeight);
	...
	public boolean onKey(View v, int keyCode, KeyEvent event) {
		...
		if (event.getAction() == KeyEvent.ACTION_DOWN) {
			...
			case KeyEvent.KEYCODE_DPAD_CENTER:
				...
				com.mediatek.wwtv.tvcenter.util.MtkLog.d(TAG, "ajust size mode: " + adjustSizeMode);
				if (this != null && adjustSizeMode == false) {
					setVisibility(View.GONE);
					invalidate();
					capActivity.createDialog(CaptureLogoActivity.DialogId.ADJUST_POSITION);
