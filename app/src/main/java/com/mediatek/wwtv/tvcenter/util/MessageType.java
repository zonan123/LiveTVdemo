...
public final class MessageType {
    ...
    public static final int MESSAGE_START_SCAN = 125;
    public static final int MESSAGE_START_ATV_SCAN = 126;
    public static final int MESSAGE_FVP_SCAN_TIP_MSG_FIRST = MESSAGE_START_ATV_SCAN + 1;
    public static final int MESSAGE_FVP_SCAN_TIP_MSG_SECOND = MESSAGE_FVP_SCAN_TIP_MSG_FIRST + 1;
    ...
    public static final int MENU_CN_TV_RF_SCAN_CONNECTTURN = 315;
    public static final int MENU_USSA_TV_RF_SCAN_CONNECTTURN = 316;
    public static final int FORM_TK_TO_MENUMAIN = 219;
    public static final int FBM_MODE_SWITCH_OK = 3333;
    public static final int MENU_TV_SCAN_TS_LOCK_STATUS = 250;
    public static final int MENU_DVBC_SCAN_HOME_FREQUENCY_TIP = MENU_TV_SCAN_TS_LOCK_STATUS+1;
