...
//    private byte[] ps_path = null;
    ...
    public static int CAP_LOGO_TV = 0;///MtkCaptureLogo.CAPTURE_SRC_TYPE_TV_VIDEO;
    public static int CAP_LOGO_MM_VIDEO = 1;///MtkCaptureLogo.CAPTURE_SRC_TYPE_MM_VIDEO;
    public static int CAP_LOGO_MM_IMAGE = 2;///MtkCaptureLogo.CAPTURE_SRC_TYPE_MM_IMAGE_ANDROID;
